...
<body class="container-fluid">
    <div class="d-flex justify-content-between mb-4">
        ...
        <a class="btn btn-primary align-self-center" href="disc_new.php">Ajouter</a>
    </div>
            ...
            <table class="col-6 d-flex mb-3">
                ...
                <tbody class="mx-3">
                    <tr class="row">
                        ...
                        <td><strong><?= $disc->artist_name //pb de nom ?></strong></td>
                    ...
                    <tr class="d-flex align-self-end mt-auto">
                        <td class=""><a class="btn btn-primary" href="disc_detail.php?id=<?= $disc->disc_id ?>">Détail</a></td>
                    </tr>
                </tbody>
            </table>
        <?php endforeach; ?>
