...
$db = connexionBase();
//Plat
$requete = $db->query("SELECT * FROM plat where active = 'yes' and id_categorie = 5");
$MyPlatAllActive = $requete->fetchAll(PDO::FETCH_OBJ);
$requete->closeCursor();
?>

<div id="fond_plat">
    <h2 class="titre_categorie_plat">Burgers</h2>
    <div id="plat">
